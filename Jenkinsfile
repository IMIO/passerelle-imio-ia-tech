pipeline {
    ...
    stages {
        stage('Build') {
            ...
            steps {
                sh "fpm -a amd64 -n passerelle-imio-ia-tech -s python -t deb -v `echo ${VERSION}` --python-install-lib /usr/lib/python3/dist-packages -d passerelle setup.py"
...
=======
>>>>>>> 87a05fe12bec237a08239dc6d01808c6962c243b
        success {
            cleanWs()
        }
    }
